...
bool askQuestion (string questions[], string answers[], char correctAnswers[], int questionSize, int answerRows,
                    int answerCols, int correctAnswerSize);
...
int main() {
    ...
    askQuestion(questions, *answers, correctAnswers, questionSize, answerRows, answerCols, correctAnswerSize);
}

bool askQuestion (string questions[], string answers[][4], char correctAnswers[], int questionSize,int answerRows,
                    int answerCols, int correctAnswerSize) {
